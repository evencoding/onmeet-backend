 ...
 */
@Deprecated(
    message = "Use BusinessException with a typed ErrorCode instead",
    replaceWith = ReplaceWith("BusinessException(errorCode)", "com.onmeet.common.exception.BusinessException")
)
